...
| `app.session.togglePin` | `ctrl+p` | Pin or unpin the selected session |
...
| `app.thinking.cycleBackward` | `alt+,` | Decrease thinking level |
| `app.thinking.cycleForward` | `alt+.` | Increase thinking level |
